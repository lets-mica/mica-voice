...
public class OnlineAsrConfig {
    ...
    public static final class Builder {
        ...
        public Builder modelDirName(String name) { c.modelDirName = name; return this; }
        public Builder modelType(ModelType t) { c.modelType = t; return this; }
        ...
        public Builder threads(Integer t) { c.threads = t; return this; }
        public Builder debug(boolean d) { c.debug = d; return this; }
        public Builder enableEndpoint(boolean b) { c.enableEndpoint = b; return this; }
        public Builder chunkSize(int n) { c.chunkSize = n; return this; }
        public Builder sampleRate(int n) { c.sampleRate = n; return this; }
        public Builder featureDim(int n) { c.featureDim = n; return this; }
        public Builder decodingMethod(String s) { c.decodingMethod = s; return this; }
        public Builder encoderCandidates(String... names) { c.encoderCandidates = names; return this; }
        public Builder decoderCandidates(String... names) { c.decoderCandidates = names; return this; }
        public Builder joinerCandidates(String... names) { c.joinerCandidates = names; return this; }

        public OnlineAsrConfig build() { return c; }
    }
}